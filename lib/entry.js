...
/**
 * Retrieve entries with given from-to indices. The offsets from and to are
 * zero-based indexes, with 0 being the first element of the list (the head of
 * the list), 1 being the next element and so on.
 *
 * @param  {Integer} from
 * @param  {Integer} to
 * @param  {Function} fn
